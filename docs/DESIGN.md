...
The long-form documentation that used to live in the README: every subsystem,
the hazards found in each vendor API, and why each decision went the way it did.
The README is the ninety-second version; this is the rest.

Start with the architecture diagram in the [README](../README.md) for the shape,
then read whichever section below you are about to change.
